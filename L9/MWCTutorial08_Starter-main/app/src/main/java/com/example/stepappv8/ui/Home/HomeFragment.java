...
//    TODO: don't forget to define the variables for the whole class
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        TextView yourTextView = root.findViewById(R.id.llm_output);
        yourTextView.setMovementMethod(new ScrollingMovementMethod());

        Log.d("Secrets Plugin",
                "BuildConfig.apiKey: " + BuildConfig.API_KEY);
...
//        TODO 6: get the refresh button and call the setOnClickListener
        ...
        refreshButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Aggiungi qui il codice per gestire il click del pulsante di refresh
                Toast.makeText(getContext(), "Refresh button clicked", Toast.LENGTH_SHORT).show();
                getLLMOuput(v);
            }
        });
    ...
    public void getLLMOuput(View view) {
        TextView yourTextView = root.findViewById(R.id.llm_output);
        ...
        String input_llm = "You are a motivational online coach. You have to provide the user with" +
                ...
                "PROVIDE THE ACTIVITIES AS A LIST LIKE: - walk to the grocery store today - run for 10 minutes. PROVIDE MAX 3 EXAMPLES. DO NOT"+
        "REPEAT THE NUMBER OF STEPS OR THE GOAL IN YOUR OUTPUT.";
        ...
        Futures.addCallback(
                ...
                new FutureCallback<GenerateContentResponse>() {
                    ...
                    public void onSuccess(GenerateContentResponse result) {
                        ...
                        yourTextView.setText(output_llm);
                    }
                    @Override
                ...
                executor);
        //yourTextView.setText("This is the LLM output");
    }
